            ...
            <div>
                ...
                <div class="accordion">
                    <div class="content-block">
                        ...
                        <label for="section1" class="main-label">A. Assessment of Employee Reliability and Task Execution</label>
                        <div class="content">
                            <label for="demonstrated_attendance" class="second-label">1. Has the employee demonstrated regular attendance and
                                punctuality?:</label>                            
                            ...
                            <div class="review-block">
                                <label for="comments_demonstrated_attendance" class="third-label">Tell us more about your experience:</label>
                                <textarea name="comments_demonstrated_attendance" id="comments" class="form-control"
                                    rows="1" cols="50" maxlength="255" placeholder="What made you give this rating? Share specific examples or feedback to help us improve."
                                ></textarea>
                            </div>


                            <div>
                                <label for="employee_manage_shift" class="second-label">2. How well does the employee manage time within the
                                    shift?:</label>
                                <select class="form-select" aria-label="multiple select example" name="employee_manage_shift"
                                    id="adr1" required>
                                    <option selected disabled>Rate</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                ...
                                <div class="review-block">
                                     <label for="comments_employee_manage_shift" class="third-label">Tell us more about your experience:</label>
                            ...
                            <div>
                                <label for="documentation_neatness" class="second-label">3. How would you rate the employee’s accuracy and
                            ...
                            <div class="review-block">
                                <label for="comments_documentation_neatness" class="third-label">Tell us more about your experience:</label>
                                <textarea name="comments_documentation_neatness" id="comments" class="form-control" rows="1"
                                    cols="50" maxlength="255" placeholder="What made you give this rating? Share specific examples or feedback to help us improve."
                                ></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="content-block">
                        ...
                        <div class="content">
                            <label for="followed_instructions" class="second-label">1. Has the employee followed administrative procedures
                            ...
                            <div class="review-block">
                                <label for="comments_followed_instructions" class="third-label">Tell us more about your experience:</label>
                                <textarea name="comments_followed_instructions" id="comments" class="form-control" rows="1"
                                    cols="50" maxlength="255" placeholder="What made you give this rating? Share specific examples or feedback to help us improve."
                                    ></textarea>
                            </div>
                            ...
                            <div>
                                <label for="productive" class="second-label">2. Does the employee effectively manage time and stay productive
                                ...
                                <div class="review-block">
                                     <label for="comments_productive" class="third-label">Tell us more about your experience:</label>
                                <textarea name="comments_productive" id="comments" class="form-control" rows="1" cols="50"
                                    maxlength="255" placeholder="What made you give this rating? Share specific examples or feedback to help us improve."></textarea>
                                </div>
                            </div>
                            <div>
                                <label for="documentation_neatness" class="second-label">3. How well does the employee handle changes in schedules or
                                    assignments?:</label>
                                <select class="form-select" aria-label="multiple select example" id="adr1"
                            ...
                            <div class="review-block">
                                <label for="comments_changes_schedules" class="third-label">Tell us more about your experience:</label>
                     ...
                     <div class="content-block">
                        ...
                        <div class="content">
                            <label for="leave_policy" class="second-label">1. Does the employee consistently adhere to the company's leave
                                    policy?:</label>
                            <select class="form-select" aria-label="multiple select example"
                                name="leave_policy" id="adr1" required>
                                <option selected disabled>Rate</option>
                                <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                            ...
                            <div class="review-block">
                                <label for="comments_leave_policy" class="third-label">Tell us more about your experience:</label>
                            ...
                            <div>
                                <label for="salary_deduction" class="second-label">2. Has there been any salary deduction due to the employee's
                                    leave?:</label>
                                ...
                                <div class="review-block">
                                     <label for="comments_salary_deduction" class="third-label">Tell us more about your experience:</label>
                                <textarea name="comments_salary_deduction" id="comments" class="form-control" rows="1"
                                    cols="50" maxlength="255" placeholder="What made you give this rating? Share specific examples or feedback to help us improve."
                                    ></textarea>
                                </div>
                            </div>
                            <div>
                                <label for="interact_housekeeping" class="second-label">3. How well does the employee interact with the
                            ...
                            <div class="review-block">
                                <label for="comments_interact_housekeeping" class="third-label">Tell us more about your experience:</label>
                                <textarea name="comments_interact_housekeeping" id="comments" class="form-control" rows="1"
                                    maxlength="255" cols="50" placeholder="What made you give this rating? Share specific examples or feedback to help us improve."
                                ></textarea>
                            </div>
                        </div>
                    </div>                     
