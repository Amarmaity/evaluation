                ...
                <div class="accordion">
                    <div class="content-block">
                        ...
                        <div class="content">
                            <label for="understand_requirements" class="second-label">1. Did the developer(s) understand
                                ...
                                clearly?:</label>
                            <!-- <input type="number" name="understand_requirements" id="cli1" min="0" max="5" required oninput="ClientTotalReview()"
                            ...
                            <div>
                                ...
                                <!-- <input type="number" name="business_needs" id="cli1" min="0" max="5" required
                            ...
                            <div>
                                <label for="detailed_project_scope" class="second-label">3. Was there a clear and
                                    ...
                                    the beginning?:</label>
                                <!-- <input type="number" name="detailed_project_scope" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                    ...
                    <div class="content-block">
                        ...
                        <div class="content">
                            ...
                            <!-- <input type="number" name="responsive_reach_project" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                            <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="comfortable_discussing" class="second-label">2. Did you feel comfortable
                                    ...
                                    suggestions?:</label>
                                <!-- <input type="number" name="comfortable_discussing" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="regular_updates" class="second-label">3. Did the developer(s) provide
                                    ...
                                    updates on
                                    progress?:</label>
                                <!-- <input type="number" name="regular_updates" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="concerns_addressed" class="second-label">4. Were your questions and concerns
                                    addressed
                                    promptly?:</label>
                                <!-- <input type="number" name="concerns_addressed" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                    ...
                    <div class="content-block">
                        ...
                        <div class="content">
                            <label for="technical_expertise" class="second-label">1. How would you rate the technical
                                expertise of the
                                developer(s)?:</label>
                            <!-- <input type="number" name="technical_expertise" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                            <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="best_practices" class="second-label">2. Were industry best practices
                                    ...
                                    process?:</label>
                                <!-- <input type="number" name="best_practices" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="suggest_innovative" class="second-label">3. Did the developer(s) suggest
                                    ...
                                    improvements?:</label>
                                <!-- <input type="number" name="suggest_innovative" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                    ...
                    <div class="content-block">
                        ...
                        <div class="content">
                            <label for="quality_code" class="second-label">1. How would you rate the quality of the code
                                delivered?:</label>
                            <!-- <input type="number" name="quality_code" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                            <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="encounter_issues" class="second-label">2. Did you encounter any bugs or
                                    issues
                                    post-launch?:</label>
                                <!-- <input type="number" name="encounter_issues" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="code_scalable" class="second-label">3. Was the code scalable and
                                    ...
                                    updates?:</label>
                                <!-- <input type="number" name="code_scalable" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="solution_perform" class="second-label">4. Did the solution perform well
                                    ...
                                    expected load and
                                    conditions?:</label>
                                <!-- <input type="number" name="solution_perform" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                    ...
                    <div class="content-block">
                        ...
                        <div class="content">
                            <label for="project_delivered" class="second-label">1. Was the project delivered on
                                time?:</label>
                            <!-- <input type="number" name="project_delivered" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                            <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="communicated_handled" class="second-label">2. If there were delays, were
                                    ...
                                    effectively?:</label>
                                <!-- <input type="number" name="communicated_handled" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="development_process" class="second-label">3. Was the development process
                                    well-organized and
                                    structured?:</label>
                                <!-- <input type="number" name="development_process" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                    ...
                    <div class="content-block">
                        ...
                        <div class="content">
                            ...
                            <!-- <input type="number" name="unexpected_challenges" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                            <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="effective_workarounds" class="second-label">2. Did the developer(s) propose
                                    ...
                                    issues arose?:</label>
                                <!-- <input type="number" name="effective_workarounds" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
                            ...
                            <div>
                                <label for="bugs_issues" class="second-label">3. How quickly were bugs or issues
                                    ...
                                    during the
                                    project?:</label>
                                <!-- <input type="number" name="bugs_issues" id="cli1" min="0" max="5" required
                                    oninput="ClientTotalReview()" placeholder="Rate Yourself">
                                </input> -->
                                <select class="form-select" aria-label="multiple select example" id="cli1"
